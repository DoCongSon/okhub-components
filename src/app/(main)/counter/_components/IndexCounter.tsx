'use client'
import CountUpWP, { CountUpWPCode } from '@/app/(main)/counter/_components/CountUpWP'
  ...
  return (
    <Tabs defaultValue='v1' className='w-full'>
      <TabsList className='grid w-full grid-cols-4'>
        ...
        <TabsTrigger value='v4'>For Wordpress</TabsTrigger>
      </TabsList>
      ...
      <TabsContent value='v4'>
        <div className='grid grid-cols-2'>
          ...
          <CodeBlock language='html' filename='example.html' code={CountUpWPCode} />
        </div>
      </TabsContent>
    </Tabs>
  )
